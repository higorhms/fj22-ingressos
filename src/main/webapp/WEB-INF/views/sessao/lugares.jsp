								...
								<c:forEach var="lugar" items="${map.value}">
									<td class="fileira-assento"><figure>
										<svg
															...
															data-lugar="${lugar}" id="${lugar.id}" version="1.0"
															id="SEAT" xmlns="http://www.w3.org/2000/svg"
															xmlns:xlink="http://www.w3.org/1999/xlink" x="0px"
															y="0px" viewBox="0 0 318.224 305.246"
															enable-background="new 0 0 318.224 305.246"
															xml:space="preserve">
											<g id="FILL">
												<path
																d="M269.395,132.246h-15.02V51.414c0-11.758-9.492-21.248-21.248-21.248H85.097
											...
											<path id="STROKE" fill="#4F4F4F"
																d="M290.664,127.709c-5.374-6.118-13.126-9.628-21.269-9.628h-0.854V51.414
